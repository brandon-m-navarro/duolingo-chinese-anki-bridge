...
(function() {
    ...
    function captureVocabularyContext(clickedElement) {
        ...
        if (!characterContainer) {
            console.log('❌ No specific character container found');
            return;
        }
        ...
        if (rubyElement) {
            ...
            console.log('❌ No ruby element found in container');
        }
    }
    ...
    function processRubyElement(rubyElement, container) {
        ...
        if (fullCharacter) {
            ...
            console.log('❌ No Chinese characters found in ruby element');
        }
    }
    ...
    async function generateTTSAudio(character, pinyin, translation) {
        ...
        if (generatedFiles[fileKey]) {
            console.log('⚠️ Duplicate detected, skipping generation:', fileKey);
        ...
        try {
            ...
            try {
                ...
                console.log('❌ Google Cloud TTS failed, trying free services:', googleError);
            ...
            GM_download({
                url: url,
                name: `Chinese_Vocabulary/${filename}`, // This creates a folder
                onload: function() {
                    ...
                    generatedFiles[fileKey] = {
                        ...
                        path: `Chinese_Vocabulary/${filename}` // Track the path
                    };
    ...
    async function generateWithBrowserTTS(text) {
        return new Promise((resolve, reject) => {
            ...
            utterance.onerror = (error) => {
                ...
                console.log('Browser TTS error, using placeholder:', error);
                resolve(audioData);
            };
    ...
    function setupGeneratorInterface() {
        ...
        configBtn.innerHTML = '⚙️ TTS Config';
    ...
    function clearAllHistory() {
        ...
        console.log('🗑️ All generation history cleared');
    }
